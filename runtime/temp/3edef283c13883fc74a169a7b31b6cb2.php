<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"D:\phpstudy\WWW\hll-china\public/../application/admin\view\banner\banner_list.html";i:1526915762;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<table class="layui-table" lay-filter="demo">
    ...
    <tr class="text-c">
        ...
        <td>
            <img src="/hll-china/public/uploads/banner/<?php echo $banner['banner_img']; ?>" style="height: 50px; height: 50px">
        </td>
