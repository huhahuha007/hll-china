<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"D:\phpstudy\WWW\hll-china\public/../application/admin\view\goods\add_category.html";i:1528249323;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<form class="layui-form" action="<?php echo url('admin/goods/save_category'); ?>" method="post">
  ...
  <div class="layui-form-item" style="width: 600px;">
    ...
    <div class="layui-input-block">
      <select name="parent_id" lay-filter="aihao">
        ...
        <option value="<?php echo $id['parent_id']; ?>" ><?php echo $id['type_name']; ?></option>
