<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"D:\phpstudy\WWW\hll-china\public/../application/admin\view\article\article_category1.html";i:1529545449;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="site-demo-button" style="margin-bottom: 0;">
    <a href="<?php echo url('admin/article/add_category'); ?>"><button class="layui-btn site-demo-active" data-type="tabAdd">新增产品分类</button></a>
...
<div class="layui-form">
    <table class="layui-table">
        ...
        <tr>
            ...
            <td>
                <a href="<?php echo url('admin/article/edit_category',array('type_id'=>$id['type_id'])); ?>" class="layui-btn">编辑</a>
                <a href="<?php echo url('admin/article/delete_category',array('type_id'=>$id['type_id'])); ?>" class="layui-btn">删除</a>
            </td>
        </tr>
